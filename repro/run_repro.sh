...
mkdir -p .tmp/leopoldt_conjecture
cp artifacts/stitch_constants.json .tmp/leopoldt_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/leopoldt_conjecture/constants_registry.json
