...
Canonical Lane research workspace for a flagship problem in algebraic number theory:
proving persistence of the expected `p`-adic regulator rank through an admissible regulator closure architecture.

## Main Manuscript

- [paper/LEOPOLDT_CONJECTURE_PREPRINT.md](paper/LEOPOLDT_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `LEOPOLDT_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/LEOPOLDT_CONJECTURE_PREPRINT.md`.
...
Current LEO runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/leo_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/leo_closure_guard.py`.
...
- Manuscript target: [paper/LEOPOLDT_CONJECTURE_PREPRINT.md](paper/LEOPOLDT_CONJECTURE_PREPRINT.md)
